# FileSqueeze Development Installer for Windows
# Installs FileSqueeze in development mode using Poetry
#
# For system-wide production installation, see install.ps1
#
# Run with: .\install-dev.ps1
